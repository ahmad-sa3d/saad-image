...
class Captcha extends Image
{
	...
	/**
	 * captcha constructor
	 * @param integer $blocks           number of captcha characters block
	 * @param integer $block_min_length minimum characters of the block
	 * @param integer $block_max_length maximum characters of the block
	 */
